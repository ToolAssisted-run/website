  ...
  apply();
    ...
    if not g.get('established', True):
        ...
        ratify_box = (
            ...
            '<h3>Ratify this game (experts)</h3>'
    ...
    gameacts = (
        ...
        '<details class="actform"><summary>Ask for this game to be removed (experts)</summary>'
        ...
        '<details class="actform"><summary>Rename this game (experts)</summary>'
        ...
        '<details class="actform"><summary>Set the game thumbnail (experts)</summary>'
        '<form id="f-gamethumb">'
        ...
        '<details class="actform"><summary>Edit a category (experts)</summary>'
        '<form id="f-gamecat">'
        ...
        '<details class="actform"><summary>Delete this game (experts)</summary>'
