...
{NONE_TICK} pending</p>''' if rows else
        ...
        gacts = ('' if gr.get('synthetic') else
                 ...
                 '<details class="actform"><summary>Add a game to this group (experts)</summary>'
                 ...
                 '<details class="actform"><summary>Ask for this group to be removed (experts)</summary>'
                 ...
                 '<details class="actform"><summary>Delete this group (experts)</summary>'
                 ...
                 'no movie is deleted. Your reason is public and permanent.</p>'
                 f'<input type="hidden" name="group" value="{esc(gr["key"])}">'
                 '<label>Why <input name="reason" required minlength="8" maxlength="500" '
...
<button class="dimopt gsort" data-mode="title">By title</button></div></div></header>
