...
import views.search  # noqa: F401,E402  (renders its pages on import)
...
import views.about  # noqa: F401,E402  (renders its pages on import)
...
# ---- stylesheets ----
# Every real CSS file in assets/ is shipped verbatim, including page-specific
# rules such as the floating run video frame.
